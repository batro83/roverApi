...
public class AppConfig {
	...
	@Bean
	public Bounds bounds(@Value("${mars.bounds.min-x}") int minX, @Value("${mars.bounds.max-x}") int maxX,
			@Value("${mars.bounds.min-y}") int minY, @Value("${mars.bounds.max-y}") int maxY) {
	...
	public RoverPosition roverPosition(@Value("${mars.initial-position.x}") int x,
			@Value("${mars.initial-position.y}") int y, @Value("${mars.initial-position.direction}") char facing) {
